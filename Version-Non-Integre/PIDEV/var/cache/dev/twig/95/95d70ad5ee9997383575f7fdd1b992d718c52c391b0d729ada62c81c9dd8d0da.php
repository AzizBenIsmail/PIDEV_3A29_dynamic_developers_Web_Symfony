...
class __TwigTemplate_089e7e86cd26eef319d9dd7ad66109ac08d953650c81803c30f640aec5a0781e extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"testbox\">
    ...
    <table class=\"table\" border=\"8\">
        <tbody>
            ...
            <tr>
                <td>";
        // line 231
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reservation_excursion"]) || array_key_exists("reservation_excursion", $context) ? $context["reservation_excursion"] : (function () { throw new RuntimeError('Variable "reservation_excursion" does not exist.', 231, $this->source); })()), "id", [], "any", false, false, false, 231), "html", null, true);
        echo "</td>
                <td><img src=\"/image/Client/";
        // line 232
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["reservation_excursion"]) || array_key_exists("reservation_excursion", $context) ? $context["reservation_excursion"] : (function () { throw new RuntimeError('Variable "reservation_excursion" does not exist.', 232, $this->source); })()), "IDClient", [], "any", false, false, false, 232), "image", [], "any", false, false, false, 232), "html", null, true);
        echo ".jpg\" width=\"300\" height=\"250\"> </td>
                <td><img src=\"/image/excursion/";
        // line 233
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["reservation_excursion"]) || array_key_exists("reservation_excursion", $context) ? $context["reservation_excursion"] : (function () { throw new RuntimeError('Variable "reservation_excursion" does not exist.', 233, $this->source); })()), "IDExcursion", [], "any", false, false, false, 233), "image", [], "any", false, false, false, 233), "html", null, true);
        echo ".jpg\" width=\"500 \" height=\"250\"> </td>
                <td>";
        // line 234
        ((twig_get_attribute($this->env, $this->source, (isset($context["reservation_excursion"]) || array_key_exists("reservation_excursion", $context) ? $context["reservation_excursion"] : (function () { throw new RuntimeError('Variable "reservation_excursion" does not exist.', 234, $this->source); })()), "DateReservationExcursion", [], "any", false, false, false, 234)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reservation_excursion"]) || array_key_exists("reservation_excursion", $context) ? $context["reservation_excursion"] : (function () { throw new RuntimeError('Variable "reservation_excursion" does not exist.', 234, $this->source); })()), "DateReservationExcursion", [], "any", false, false, false, 234), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    {
        return array (  316 => 243,  311 => 241,  306 => 239,  298 => 234,  294 => 233,  290 => 232,  286 => 231,  263 => 213,  102 => 55,  51 => 7,  43 => 1,);
    }
    ...
    <table class=\"table\" border=\"8\">
        <tbody>
            ...
            <tr>
                ...
                <td><img src=\"/image/Client/{{ reservation_excursion.IDClient.image}}.jpg\" width=\"300\" height=\"250\"> </td>
                <td><img src=\"/image/excursion/{{ reservation_excursion.IDExcursion.image}}.jpg\" width=\"500 \" height=\"250\"> </td>
                <td>{{ reservation_excursion.DateReservationExcursion ? reservation_excursion.DateReservationExcursion|date('Y-m-d') : '' }}</td>
            </tr>
        </tbody>
    </table>

                <a href=\"{{ path('reservation_excursion_index') }}\"><button>Back to list</button></a>
...
</html>", "reservation_excursion/show.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\reservation_excursion\\show.html.twig");
    }
}
