...
class __TwigTemplate_3dc539575052fee87f72495946431fbcfe0769debb2ff9b16698c05a44e77611 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"testbox\">
    <div style=\" width: 100%;
        ...
        <br/>
        <fieldset>
            <legend>Create new Excursion</legend>
            <div class=\"colums\">
    ...
    ";
        // line 223
        echo twig_include($this->env, $context, "excursion/_form.html.twig");
        echo "
                </table>
                <a href=\"";
        // line 225
    ...
    {
        return array (  283 => 225,  278 => 223,  263 => 213,  102 => 55,  51 => 7,  43 => 1,);
    }
...
<div class=\"testbox\">
    ...
    {{ include('excursion/_form.html.twig') }}
                </table>
                <a href=\"{{ path('excursion_index') }}\"><button>back to list</button></a>
            </div>
</body>
</html>", "excursion/new.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\excursion\\new.html.twig");
    }
}
