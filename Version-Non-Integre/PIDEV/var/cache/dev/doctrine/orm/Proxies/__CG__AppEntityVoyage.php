...
class Voyage extends \App\Entity\Voyage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'ID_Client', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Destination', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Nom_Voyage', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Duree_Voyage', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Prix_Voyage', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'date', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'valabilite', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Image'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIDClient(?\App\Entity\Client $ID_Client): \App\Entity\Voyage
    {
    ...
    public function getPrixVoyage(): ?float
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPrixVoyage', []);

        return parent::getPrixVoyage();
    }

    /**
     * {@inheritDoc}
     */
    public function setPrixVoyage(float $Prix_Voyage): \App\Entity\Voyage
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrixVoyage', [$Prix_Voyage]);

        return parent::setPrixVoyage($Prix_Voyage);
    }
