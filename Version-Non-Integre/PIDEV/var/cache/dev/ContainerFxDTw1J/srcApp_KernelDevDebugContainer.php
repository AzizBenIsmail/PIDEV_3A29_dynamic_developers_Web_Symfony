...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.9SmgUmK' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_9SmgUmKService()
    {
        return $this->privates['.service_locator.9SmgUmK'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd826c = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer65309 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesd0299 = [
        
    ];

    public function getConnection()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getConnection', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getMetadataFactory', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getExpressionBuilder', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'beginTransaction', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getCache', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getCache();
    }

    public function transactional($func)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'transactional', array('func' => $func), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'wrapInTransaction', array('func' => $func), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'commit', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->commit();
    }

    public function rollback()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'rollback', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getClassMetadata', array('className' => $className), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'createQuery', array('dql' => $dql), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'createNamedQuery', array('name' => $name), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'createQueryBuilder', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'flush', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'clear', array('entityName' => $entityName), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->clear($entityName);
    }

    public function close()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'close', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->close();
    }

    public function persist($entity)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'persist', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'remove', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'refresh', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'detach', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'merge', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getRepository', array('entityName' => $entityName), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'contains', array('entity' => $entity), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getEventManager', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getConfiguration', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'isOpen', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getUnitOfWork', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getProxyFactory', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'initializeObject', array('obj' => $obj), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'getFilters', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'isFiltersStateClean', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'hasFilters', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return $this->valueHolderd826c->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer65309 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd826c) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd826c = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd826c->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, '__get', ['name' => $name], $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        if (isset(self::$publicPropertiesd0299[$name])) {
            return $this->valueHolderd826c->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd826c;
    ...
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;
    ...
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, '__isset', array('name' => $name), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;
    ...
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, '__unset', array('name' => $name), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;
    ...
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, '__clone', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        $this->valueHolderd826c = clone $this->valueHolderd826c;
    }

    public function __sleep()
    {
        $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, '__sleep', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;

        return array('valueHolderd826c');
    }
    ...
    {
        $this->initializer65309 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer65309;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer65309 && ($this->initializer65309->__invoke($valueHolderd826c, $this, 'initializeProxy', array(), $this->initializer65309) || 1) && $this->valueHolderd826c = $valueHolderd826c;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd826c;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd826c;
    }
}
