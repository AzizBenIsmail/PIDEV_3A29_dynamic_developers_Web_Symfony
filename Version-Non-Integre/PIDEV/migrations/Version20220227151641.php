 ...
 */
final class Version20220227151641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_voyage ADD CONSTRAINT FK_776CC0CEE8FC5988 FOREIGN KEY (id_voyage_id) REFERENCES voyage (id) ON DELETE CASCADE');
    }
