 ...
 */
final class Version20220227141522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voyage CHANGE date date DATE DEFAULT NULL, CHANGE valabilite valabilite VARCHAR(255) NOT NULL');
    }
