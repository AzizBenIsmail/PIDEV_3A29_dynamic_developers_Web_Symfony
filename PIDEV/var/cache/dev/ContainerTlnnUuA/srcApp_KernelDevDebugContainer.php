...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder3e506 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6e72a = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties2daf7 = [
        
    ];

    public function getConnection()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getConnection', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getMetadataFactory', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getExpressionBuilder', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'beginTransaction', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getCache', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getCache();
    }

    public function transactional($func)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'transactional', array('func' => $func), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'wrapInTransaction', array('func' => $func), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'commit', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->commit();
    }

    public function rollback()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'rollback', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getClassMetadata', array('className' => $className), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'createQuery', array('dql' => $dql), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'createNamedQuery', array('name' => $name), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'createQueryBuilder', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'flush', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'clear', array('entityName' => $entityName), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->clear($entityName);
    }

    public function close()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'close', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->close();
    }

    public function persist($entity)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'persist', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'remove', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'refresh', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'detach', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'merge', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getRepository', array('entityName' => $entityName), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'contains', array('entity' => $entity), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getEventManager', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getConfiguration', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'isOpen', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getUnitOfWork', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getProxyFactory', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'initializeObject', array('obj' => $obj), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'getFilters', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'isFiltersStateClean', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'hasFilters', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return $this->valueHolder3e506->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer6e72a = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder3e506) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder3e506 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder3e506->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, '__get', ['name' => $name], $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        if (isset(self::$publicProperties2daf7[$name])) {
            return $this->valueHolder3e506->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder3e506;
    ...
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;
    ...
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, '__isset', array('name' => $name), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;
    ...
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, '__unset', array('name' => $name), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;
    ...
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, '__clone', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        $this->valueHolder3e506 = clone $this->valueHolder3e506;
    }

    public function __sleep()
    {
        $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, '__sleep', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;

        return array('valueHolder3e506');
    }
    ...
    {
        $this->initializer6e72a = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer6e72a;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer6e72a && ($this->initializer6e72a->__invoke($valueHolder3e506, $this, 'initializeProxy', array(), $this->initializer6e72a) || 1) && $this->valueHolder3e506 = $valueHolder3e506;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder3e506;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder3e506;
    }
}
