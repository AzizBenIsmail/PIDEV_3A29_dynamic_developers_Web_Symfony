 ...
 */
final class Version20220214213917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_voyage ADD travel_class VARCHAR(255) NOT NULL, ADD age INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_voyage DROP travel_class, DROP age');
