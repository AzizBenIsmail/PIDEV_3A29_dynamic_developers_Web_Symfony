 ...
 */
final class Version20220216164627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE excursion ADD image VARCHAR(255) DEFAULT NULL');
