...
//        }
    ...
    public function pdf(UserRepository $UserRepository)
    {
     ...
     /**
     * @Route("/listUserWithSearch", name="listUserWithSearch")
     */
    public function listUserWithSearch(Request $request, UserRepository $userRepository)
    {
        //All of Student
        ...
        if ($searchForm->isSubmitted()) {
            ...
            return $this->render('Security/searchUser.html.twig', array(
                "clients" => $resulta,
