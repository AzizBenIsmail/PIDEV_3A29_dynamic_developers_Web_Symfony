...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.vR1dqZK' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_VR1dqZKService()
    {
        return $this->privates['.service_locator.vR1dqZK'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.vR1dqZK'] ?? $this->get_ServiceLocator_VR1dqZKService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2babe = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b5fc = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties7dc4a = [
        
    ];

    public function getConnection()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getConnection', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getMetadataFactory', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getExpressionBuilder', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'beginTransaction', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getCache', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getCache();
    }

    public function transactional($func)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'transactional', array('func' => $func), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->transactional($func);
    }

    public function commit()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'commit', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->commit();
    }

    public function rollback()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'rollback', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getClassMetadata', array('className' => $className), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'createQuery', array('dql' => $dql), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'createNamedQuery', array('name' => $name), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'createQueryBuilder', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'flush', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'clear', array('entityName' => $entityName), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->clear($entityName);
    }

    public function close()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'close', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->close();
    }

    public function persist($entity)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'persist', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'remove', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'refresh', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'detach', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'merge', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'contains', array('entity' => $entity), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getEventManager', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getConfiguration', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'isOpen', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getUnitOfWork', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getProxyFactory', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'initializeObject', array('obj' => $obj), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'getFilters', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'isFiltersStateClean', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'hasFilters', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return $this->valueHolder2babe->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5b5fc = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2babe) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2babe = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2babe->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, '__get', ['name' => $name], $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        if (isset(self::$publicProperties7dc4a[$name])) {
            return $this->valueHolder2babe->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2babe;
    ...
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;
    ...
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, '__isset', array('name' => $name), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;
    ...
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, '__unset', array('name' => $name), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;
    ...
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, '__clone', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        $this->valueHolder2babe = clone $this->valueHolder2babe;
    }

    public function __sleep()
    {
        $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, '__sleep', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;

        return array('valueHolder2babe');
    }
    ...
    {
        $this->initializer5b5fc = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer5b5fc;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer5b5fc && ($this->initializer5b5fc->__invoke($valueHolder2babe, $this, 'initializeProxy', array(), $this->initializer5b5fc) || 1) && $this->valueHolder2babe = $valueHolder2babe;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2babe;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2babe;
    }
}
