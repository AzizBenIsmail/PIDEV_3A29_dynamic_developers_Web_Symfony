...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.ATpfzyy' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_ATpfzyyService()
    {
        return $this->privates['.service_locator.ATpfzyy'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\BackController::index' => ['privates', '.service_locator.cw1lhOR', 'get_ServiceLocator_Cw1lhORService', false],
